...
MyStation-Go needs a WiFi connection to fetch weather and transport data. This page explains what kind
...
When you first set up MyStation-Go,
...
graph LR
    ...
    AP -- " 3. MyStation-Go connects\nto your router " --> Router
    Router -- " 4. MyStation-Go finds\nyour location " --> AP
```
...
4. MyStation-Go connects to your router and finds nearby transport stops automatically
5. Finish the rest of the settings and press **Save** — the device restarts

> 💡 During this step, your phone is connected directly to MyStation-Go — not to your home WiFi.
...
your phone and MyStation-Go must both be connected to **the same home WiFi network**. Then you can open the settings page
in your browser.
...
> to reach the MyStation-Go settings page. Switch your phone to home WiFi first.

---

### Normal Operation — Daily Use

Once set up, MyStation-Go connects to your home WiFi and fetches data from the internet automatically.
...
provider. MyStation-Go will need to connect to the 2.4 GHz one.

**MyStation-Go connects but can't reach the settings page from my phone**
...
**Should I place MyStation-Go close to the router?**
